...
export function getFieldId(formId: string, options: any, index: string|number) {
...
export function getFieldModel(model: any, field: any, constructEmptyObjects: boolean): any {
